...
## 6. Create the profiles table (recommended)

To store profile data (e.g. role, full name) and have a row created automatically on signup:

1. In Supabase Dashboard go to **SQL Editor**.
2. Open the file **`supabase/migrations/001_create_profiles.sql`** in this repo, copy its contents, paste into the SQL Editor, and run it.

See **`docs/AUTH_TABLES_AND_FLOW.md`** for a description of auth tables (login/signup flow and the `profiles` table).
